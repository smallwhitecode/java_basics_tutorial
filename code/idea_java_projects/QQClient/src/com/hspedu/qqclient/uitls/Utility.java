package com.hspedu.qqclient.uitls;
...
public class Utility {
    ...
    /**
     * 功能：读取键盘输入的整数或默认值，如果直接按回车，则返回指定的默认值
     * @param defaultValue 指定的默认值
     * @return 整数或默认值
     */
    ...
    /**
     * 功能：读取键盘输入的指定长度的字符串或默认值，如果直接回车，则返回指定的默认值
     * @param limit 限制的长度
     * @param defaultValue 指定的默认值
     * @return 指定长度的字符串
     */
     ...
     * 功能：读取一个字符串
     * @param limit 读取的长度
     * @param blackReturn 如果为true ，表示 可以读空字符串
     *                    如果为false表示，不能读空字符串
    ...
    private static String readKeyBoard(int limit, boolean blackReturn) {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (line.length() == 0) {
                if (blackReturn) return line;//如果blankReturn=true,可以返回空串
